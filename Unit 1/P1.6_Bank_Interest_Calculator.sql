...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Principal: Rs.' || TO_CHAR(v_p, '99,999.00'));
    DBMS_OUTPUT.PUT_LINE('Rate: ' || v_r || '%');
    DBMS_OUTPUT.PUT_LINE('Years: ' || v_t);
    DBMS_OUTPUT.PUT_LINE('Simple Interest: Rs.' || TO_CHAR(v_si, '99,999.00'));
    DBMS_OUTPUT.PUT_LINE('Simple Interest Amount: Rs.' || TO_CHAR(v_si_amount, '99,999.00'));
    DBMS_OUTPUT.PUT_LINE('Compound Interest: Rs.' || TO_CHAR(v_ci, '99,999.00'));
    DBMS_OUTPUT.PUT_LINE('Compound Interest Amount: Rs.' || TO_CHAR(v_ci_amount, '99,999.00'));
